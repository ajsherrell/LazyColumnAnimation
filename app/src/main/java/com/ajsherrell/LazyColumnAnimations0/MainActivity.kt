...
class MainActivity : ComponentActivity() {
    ...
    private val animalsDescriptions = mapOf(
...
//                            AnimalListScaleIn(animals = animals, navController = navController)
                        ...
                        composable("animal_detail/{animal}") { backStackEntry ->
                            ...
                            val color = animalColors[animal] ?: Color.LightGray
                            val description = animalsDescriptions[animal] ?: ""
                            if (animal != null) {
...
@Composable
fun AnimalRow(animal: String, color: Color? = null, navController: NavController) {
    ...
    Box(
        modifier = Modifier
            .fillMaxWidth()
            .clickable {
                Toast.makeText(context, "Clicked on $animal", Toast.LENGTH_SHORT).show()
//                navController.navigate("animal_detail/$animal")
            }
//            .background(color = animalColor)
    ) {
        Text(
            text = animal,
            modifier = Modifier
